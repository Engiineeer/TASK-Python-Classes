...
vendor_aziz = Vendor("Asis", 10, 10)  # create a new vendor named Asis at location 10 with a money value of 10
nearby_customer = Customer("MishMish", 11, 10)  # create a new customer named MishMish at location 11 with a money value of 10
distant_customer = Customer("Hamsa", 1000, 1000)  # create a new customer named Hamsa at location 1000 with a money value of 10
broke_customer = Customer("Maskeen", 12, 0)  # create a new customer named Maskeen at location 12 with 0 money
